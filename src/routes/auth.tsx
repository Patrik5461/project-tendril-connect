            ...
            {isSignup && (
              <>
                <div className="rounded-md border border-primary/30 bg-primary/5 p-3 text-xs">
                  {native ? (
                    <>
                      <b className="text-primary">30 dní zdarma</b> (vrátane 5 AI analýz). Bez
                      platobnej karty. Zrušiteľné kedykoľvek.
                    </>
                  ) : (
                    <>
                      <b className="text-primary">30 dní zdarma</b> (vrátane 5 AI analýz), potom
                      4,99 € / mes (Základ) alebo 14,99 € / mes (Prémium). Bez platobnej karty.
